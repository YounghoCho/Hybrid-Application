...
<table style="width:100%;height:11%;margin-top:-3%;margin-bottom:0%;background-color:#DCDDDD;">
    <tr>
		...
		?>
        &nbsp;
		<input style="width:30%;background-color:#898989;color:#fff;border:none;padding:2px;border:1px solid #fff;padding-bottom:4px;" type="button" value="삭제" onClick="board_delete('<?=$data["b_idx"]?>');">
        <?php
		}
		?>
        </td>
