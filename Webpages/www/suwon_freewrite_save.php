...
*/
$sql = "insert into tb_board2 set b_reply = '', m_id = '".$_SESSION["user_id"]."', m_name = '".$_SESSION["user_name"]."', b_title = '".$_POST["b_title"]."', b_contents = '".$_POST["b_contents"]."', b_regdate = now(), ip='".$_POST["ip"]."';";
sql_query($sql);
