...
$page_scale = 3;
$paging_str = "";
$sql = "select count(*) as cnt from tb_board4 where b_title like '%".$_GET['class']."%';";
$total_count = sql_total($sql);
$paging_str = paging($page, $page_row, $page_scale, $total_count);
$from_record = ($page - 1) * $page_row;

$query = "select * from tb_board4 where b_title like '%".$_GET['class']."%' order by b_num desc, b_reply asc limit ".$from_record.", ".$page_row;
		...
		<td style="width:90%;height:60px;align:left;background-color:#fff;padding:3px;padding-left:7px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;border-bottom:1px solid #ccc;">
			...
			<tr>
				<td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">
					<a href="./suwon_classboard_view.php?b_num=<?=$data["b_num"]?>&page=<?=$page?>">
