...
<!--
<font size="2%" face="'Jeju Gothic',sans-serif" color="#22304e"><b>&nbsp;게시판 선택 :
<select name="sel" style="margin:3px;padding:2px;background-color:#ffffff;border:#ccc solid 1px;font-color:#22304e">
<option value="n">선택</option>
<option value="a">자유게시판</option>
<option value="b">사람찾기</option>
<option value="c">분실물</option>
<option value="d">벼룩시장</option>
<option value="e">강의정보</option>
<option value="f">동아리</option>
</select>
-->
<table style="width:100%;height:65%;border:0px;">
    <tr>
        <td align="center" valign="middle" style="width:20%;height:5%;background-color:#22304e;"> <font size="2%" color="white"><b>글제목</td>
        <td align="left" valign="middle" style="width:80%;height:10%;"><input id="t" type="text" name="b_title" style="width:100%;height:100%;font-size:150%; color:#172134;;font-family:'Hanna', serif;"></td>
    </tr>
    <tr>
		...
		<textarea id="ccc" name="b_contents" style="width:100%;height:100%; color:#172134;font-family:'Hanna', serif;"></textarea>
        </td>
    </tr>
    <tr>
        <td align="center" valign="middle" colspan="2">
		<input style="width:20%;background-color:#22304e;color:#fff8f2;border:1px solid #22304e;font-family:'Hanna',serif;padding:2px" type="button" value=" 글쓰기 " onClick="write_save();"></td>
    </tr>
</table>
</form>
<script>
